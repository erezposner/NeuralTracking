...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, bn=torch.nn.BatchNorm2d):
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, bn=torch.nn.BatchNorm2d):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, bn=torch.nn.BatchNorm2d):
        downsample = None
        ...
        layers = []
        layers.append(block(self.inplanes, planes, stride, downsample, bn))
