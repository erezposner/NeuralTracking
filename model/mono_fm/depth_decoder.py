...
class DepthDecoder(nn.Module):
    def __init__(self,  num_ch_enc):
        ...
        # disp
        self.disp4 = nn.Sequential(Conv3x3(bottleneck, 1), nn.Softplus())
        self.disp3 = nn.Sequential(Conv3x3(bottleneck, 1), nn.Softplus())
        self.disp2 = nn.Sequential(Conv3x3(bottleneck, 1), nn.Softplus())
        self.disp1 = nn.Sequential(Conv3x3(bottleneck, 1), nn.Softplus())
    ...
    def forward(self, input_features, frame_id=0):
        ...
        self.outputs[("depth", frame_id, 3)] = disp4
        self.outputs[("depth", frame_id, 2)] = disp3
        self.outputs[("depth", frame_id, 1)] = disp2
        self.outputs[("depth", frame_id, 0)] = disp1
